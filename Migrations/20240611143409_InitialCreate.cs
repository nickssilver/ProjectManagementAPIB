        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Institutions_Counties_CountyID",
                        column: x => x.CountyID,
                        principalTable: "Counties",
                        principalColumn: "CountyID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Institutions_InstitutionStages_StageID",
                        column: x => x.StageID,
                        principalTable: "InstitutionStages",
                        principalColumn: "StageID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Institutions_InstitutionStatuses_StatusID",
                        column: x => x.StatusID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Institutions_CountyID",
                table: "Institutions",
                column: "CountyID");

            migrationBuilder.CreateIndex(
                name: "IX_Institutions_StageID",
                table: "Institutions",
                column: "StageID");

            migrationBuilder.CreateIndex(
                name: "IX_Institutions_StatusID",
                table: "Institutions",
                column: "StatusID");
        }
